...
import EquityDetails from "../../modal/EquityDetails";
import StockPlan from "../../modal/StockPlan";
...
const Employer:React.FC<TEmployerProps> = ( props ) => {
  ...
  return (
    <BoxPanel sx={{p:'12px'}}>
          ...
          <Grid item xs={12} key={index}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={9} md={9}>
                <Grid container >
                  <Grid item xs={12}
                   sx={{'> div':{minHeight:'0px !important'}}}
                   >
      ...
      >
        <EquityDetails modalClose={detailHandleClose} />
      </Modal>
      <Modal
        open={updateOpen}
